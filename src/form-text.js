...
export default function FormText() {
    ...
    return(
        ...
        <form>
            ...
            <div className="form-group mb-2">
                <label htmlFor="pswd2">รหัสผ่านทั้งสองช่องไม่ตรงกัน</label>
                <input type="password" id="pawd2" className="form-control form-control-sm" ref={textPswd2} onBlur={onBlurPassword2}></input>
            </div>
            <div className="form-group mb-4">
                <label htmlFor="memo" name="memo">บันทึกช่วยจำ</label>
